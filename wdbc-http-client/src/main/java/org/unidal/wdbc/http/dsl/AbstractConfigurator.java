...
public abstract class AbstractConfigurator {
   ...
   protected QueryProcessor processor(String name, Class<? extends org.unidal.wdbc.http.Processor> processorClass) {
   ...
   public static interface Processor extends Requirement {
      ...
      public Class<? extends org.unidal.wdbc.http.Processor> getProcessorClass();
   ...
   public static class QueryProcessor extends BaseComponent<QueryProcessor> implements Processor {
      ...
      private Class<? extends org.unidal.wdbc.http.Processor> m_processorClass;

      public QueryProcessor(String name, Class<? extends org.unidal.wdbc.http.Processor> processorClass) {
         m_name = name;
