...
import org.unidal.wdbc.http.impl.HttpResponseSource;

public class Processor implements org.unidal.wdbc.http.Processor, LogEnabled, Initializable {
   ...
   public void execute(Session session) {
      ...
      if (body != null && body.startsWith("�����ϵ: ��Ƹ")) {
         type = "1"; // iwant
      } else if (body != null && body.startsWith("�����ϵ: ��ְ")) {
         type = "2"; // ihave
      } else {
         type = "3"; // unknown
      }
